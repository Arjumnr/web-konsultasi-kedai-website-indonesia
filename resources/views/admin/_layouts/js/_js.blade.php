...
<!-- JS Libraies -->
<script src="{{ asset('templates/node_modules/simpleweather/jquery.simpleWeather.min.js') }}"></script>
<script src="{{ asset('templates/node_modules/chart.js/dist/Chart.min.js') }}"></script>
<script src="{{ asset('templates/node_modules/jqvmap/dist/jquery.vmap.min.js') }}"></script>
<script src="{{ asset('templates/node_modules/jqvmap/dist/maps/jquery.vmap.world.js') }}"></script>
